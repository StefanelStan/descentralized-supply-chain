...
contract('SupplyChain', accounts => {
    ...
    let originMinerID = accounts[1];
    let originMineName = "John Doe";
    let originMineInformation = "Yarray Valley";
    let originMineLatitude = "-38.239770";
    let originMineLongitude = "144.341490";
    let productID = sku + upc;
    let productNotes = "Shiniest diamond from the world!";
    let productPrice = web3.utils.toWei("1", "ether");
    let itemState = 0;
    let manufacturerID = accounts[2];
    let masterjewelerID = accounts[3];
    let retailerID = accounts[4];
    let customerID = accounts[5];
    ...
    describe('Test suite: contract destruction', () => {
        ...
        it('should not allow further contract calls when contract has been killed/destroyed', async() => {
            ...
            expectToRevert(contractInstance.owner());
        });
    });
